...
def svm_loss_vectorized(W, X, y, reg):
  ...
  loss = np.sum(np.maximum(margins, np.zeros(margins.shape))) / num_train
  loss -= 1 # minus one for not excluding the correct class
  loss += reg * np.sum(W * W)
  #############################################################################
  #                             END OF YOUR CODE                              #
  #############################################################################
  ...
  # loss.                                                                     #
  #############################################################################
  mask = (margins > 0) * np.ones(margins.shape)
